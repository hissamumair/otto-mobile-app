...
export default function SignupScreen4({ navigation }) {
  ...
  const handleVerifyCode = () => {
    ...
    navigation.navigate('SignupScreen5'); // Navigate to ConfirmEmail screen
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.verifyText}>Confirm Your Email</Text>
      ...
      </View><TouchableOpacity onPress={handleResendCode} style={{top:40,backgroundColor:"white",height:"5%",width:"90%",alignSelf:"center"}}>
            {/* <Feather name="send" size={20} color="#000" style={styles.resendIcon} /> */}
            <Text style={{fontSize:16,color:"black",alignSelf:"center",fontWeight:"semibold"}}>Skip, I’ll confirm later</Text>
          </TouchableOpacity>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  resendContainer: {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    marginTop: 0, // Adjusted margin to move up
  },
  timerText: {
    fontSize: 16,
    color: '#333', // Darker text color
